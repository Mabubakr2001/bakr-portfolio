...
import Intelcia from "../../../public/images/intelcia.webp"
...
export default function Experiences() {
  return (
    <section className="mb-14" id="experience">
      ...
      <Experience companyImg={<img src={Intelcia} alt="Intelcia Photo" className="w-24 h-24 rounded-full mb-5 md:mb-0"/>} companyName="Intelcia" accountName="Optimum" title="Customer Service Representative" period="Aug 2024 - Sep 2024" rule="Worked at the mobile department where our job was to make sure that the customer is receiving the Telecom experience that he wants. The mobile department wasn’t that hard, it was a piece of cake for me, so to speak, because our main focus was on the SIM card. Used to check on the customer’s bill, paying it, adding some features to his plan, and solving some technical issues."/>
